...
public class Room : MonoBehaviour
{
    ...
    void Start()
    {
        ...
        doorOpenMessage.text = "Door Locked";
        doorOpenMessage.color = Color.cyan;
        retryMessage.text = "";
    }
    ...
    public void OpenDoor()
    {
        ...
        {          
            ...
            doorOpenMessage.text = "Right Code";
            doorOpenMessage.color = Color.green;
    ...
    void OpeningDoor(float t)
    {
        ...
        if (t > 1)
        {
            ...
            doorOpenMessage.text = "Door Open";
            doorOpenMessage.color = Color.green;
        }
    }
    ...
    public void setDoorOpenMessage(string msg, Color color)
    {
        doorOpenMessage.text = msg;
        doorOpenMessage.color = color;
    }

    public void setRetryMessage(string msg)
    {
        retryMessage.text = msg;
    }
    ...
    public void Retry()
{
    ...
    if (door2)
        door2.transform.position = door2ClosedPosition;
