...
public class Panel : MonoBehaviour
{
    ...
    void Update()
    {
        ...
        {
            room.setDoorOpenMessage("Wrong Code", Color.red);
            room.setRetryMessage("R to retry");
            ...
            {
                StopAlarm();
                room.setDoorOpenMessage("Door Locked", Color.cyan);
                room.setRetryMessage("");
            }
        }
    ...
    public void Retry()
{
    ...
    // Reset prediction UI
    predictionText.text = "?";
    if (probabilityText) probabilityText.text = "";
